  ...
  render() {
    ...
    return (
      ...
      <Grid style = {{backgroundColor:'#FFF', width: '90vw'}}>
        ...
        <p className="descriptionText">"They will work with real-world applications of advanced computation methods such as computer vision, pattern recognition, and autonomous vehicle controls."
          <br/>
          - GM Newsroom
          <br/><br/>
          The main prize is being accepted to compete. We get the vehicle and the funding to do this project. That's the main benefit for the students.<br/>
